    ...
    class Carousel extends Module_Base {
        ...
        private function register_query_section_controls() {
            ...
            $this->add_control(
                'content_show',
                [
                    'label' => __( 'Content Show', 'bdthemes-element-pack' ) . BDTEP_NC,
                    'type'  => Controls_Manager::SELECT,
                    'options' => [
                        'onhover' => __( 'On Hover', 'bdthemes-element-pack' ),
                        'alwaysopen'  => __( 'Always Open', 'bdthemes-element-pack' ),
                    ],
            ...
            $this->start_controls_section(
                ...
                [
                    'label'     => __( 'Readmore', 'bdthemes-element-pack' ),
                    'condition' => [
                        '_skin!' => 'bdt-alice'
                    ],
                ]
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Content Background', 'bdthemes-element-pack' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_control(
                ...
                [
                    'label'     => __( 'Content Border Color', 'bdthemes-element-pack' ),
                    'type'      => Controls_Manager::COLOR,
                    'selectors' => [
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => ['px', '%'],
                    'selectors'  => [
                        '{{WRAPPER}} .bdt-ep-carousel-item, {{WRAPPER}} .swiper-container' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
