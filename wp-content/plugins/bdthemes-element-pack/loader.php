...
class Element_Pack_Loader {
	...
	public function register_site_scripts() {
		...
		if (element_pack_is_widget_enabled('scrollnav') or element_pack_is_widget_enabled('price-table') or element_pack_is_widget_enabled('marker') or element_pack_is_widget_enabled('logo-grid') or element_pack_is_widget_enabled('logo-carousel') or element_pack_is_widget_enabled('iconnav') or element_pack_is_widget_enabled('helpdesk') or element_pack_is_widget_enabled('circle-menu')) {
		...
		if (element_pack_is_widget_enabled('interactive-card') or element_pack_is_widget_enabled('image-expand') or element_pack_is_widget_enabled('animated-heading') or element_pack_is_widget_enabled('horizontal-scroller')) {
