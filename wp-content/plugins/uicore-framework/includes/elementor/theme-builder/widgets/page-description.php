...
class PageDescription extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Page Description', 'elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'fallabck_text',
			[
				'label' => __( 'Fallback text', 'uicore-framework' ),
				'description' => esc_html__('If is empty and page does not have any description nothing will be displayed.', 'uicore-framework'),
	...
	protected function render() {
        ...
        if( !\Elementor\Plugin::$instance->editor->is_edit_mode() ) {
            $title = get_post_meta(\get_the_ID(), 'page_description', true);
        }else{
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new PageDescription());
