...
$css .= $this->background($json_settings['header_bg'] , '.uicore-mobile-menu-wrapper:before, .uicore-navbar .uicore-header-wrapper:before, #uicore-back-to-top, .uicore-wrapper.uicore-search.elementor-section');
...
if($json_settings['submenu_trigger'] === 'click'){
    $css .= "
