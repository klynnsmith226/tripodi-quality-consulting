...
<script>
const DEFAULT_COLOR_CHECKED = 'var(--uicore-primary,#532df5)';
const DEFAULT_COLOR_UNCHECKED = 'var(--uicore-base-input-focus-bg)';
...
export default {
    ...
    computed: {
        ...
        buttonStyle() {
            ...
            const transform = this.toggled ? translate3d(this.distance, margin) : translate3d(margin, margin);
